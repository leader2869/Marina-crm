...
export default function Layout() {
  ...
  const navigation = useMemo(() => {
    const allItems: Array<{
      ...
      { name: 'Мини игры', href: '/mini-games', icon: Gamepad2, roles: [UserRole.SUPER_ADMIN, UserRole.ADMIN, UserRole.VESSEL_OWNER, UserRole.AGENT, UserRole.CAPTAIN, UserRole.MECHANIC, UserRole.GUEST, UserRole.PENDING_VALIDATION] },
