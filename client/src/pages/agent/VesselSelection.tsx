    ...
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="mt-2 text-gray-600">Поиск и подбор катеров для заказов</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">Функционал подборки катеров будет доступен в ближайшее время</p>
        </div>
      </div>
    </div>
  )
