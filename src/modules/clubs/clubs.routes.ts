...
router.get('/:id/media', optionalAuthenticate, clubsController.getClubMedia.bind(clubsController));
router.get('/:id', optionalAuthenticate, clubsController.getById.bind(clubsController));
